            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <p class="mb-0 text-amber-800" style="color: #92400e; font-size: 13.5px;">
                        ...
                        Vui lòng hoàn thành đăng ký trước khi hết hạn để tránh bị Trưởng khoa tự động chỉ định trực.
                    </p>
                </div>
                <div>
...
<!-- Lớp 3: Thống kê Quota ca trực dành cho Trưởng Khoa -->
        ...
        <div class="content-card p-4 border-0 shadow-sm bg-white" style="border-radius: 16px;">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="fw-bold mb-0 text-dark d-flex align-items-center gap-2">
                    ...
                    Bảng Giám sát Chỉ tiêu Trực Đêm của Khoa (Trưởng khoa)
                </h6>
    ...
    <div class="col-12">
        <div class="content-card p-4 border-0 shadow-sm" style="border-radius: 16px; background: #ffffff;">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="index.php?page=inpatient&action=admit" class="btn btn-outline-danger px-3 py-2" style="border-radius: 10px; font-weight: 600; font-size: 13.5px;">
                    <i class="fa-solid fa-hospital-user me-1.5"></i> Chỉ định nhập viện
                </a>
