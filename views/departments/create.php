    ...
    <div class="col-md-8 col-lg-6">
        <div class="card border-0 shadow-sm" style="border-radius: 16px; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
            <div class="card-header bg-transparent border-0 pt-4 pb-0 px-4 text-center">
                <div class="icon-box rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px; background: linear-gradient(135deg, rgba(13,110,253,0.1), rgba(13,110,253,0.2)); color: var(--bs-primary);">
                    <i class="fa-solid fa-building-columns fs-3"></i>
                </div>
                <h4 class="fw-bold text-dark">Thêm Khoa Mới</h4>
                <p class="text-muted small">Vui lòng điền thông tin chi tiết của khoa mới bên dưới.</p>
            </div>
            <div class="card-body p-4">
                <form method="POST" action="index.php?page=departments&action=store">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light border-0" id="name" name="name" required placeholder="Nhập tên khoa..." style="border-radius: 8px;">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control bg-light border-0" id="description" name="description" rows="5" placeholder="Nhập mô tả chi tiết cho khoa này..." style="border-radius: 8px; resize: none;"></textarea>
                    </div>
                                    ...
                                    <div class="options-container" style="max-height: 200px; overflow-y: auto;">
                                        <?php foreach ($doctors as $doctor): ?>
                                            <label class="dropdown-item d-flex align-items-center gap-2 rounded option-item">
                                                <input class="form-check-input mt-0 item-checkbox" type="checkbox" name="doctors[]" value="<?= $doctor['id'] ?>">
                                ...
                                <div class="dropdown-menu w-100 p-2 shadow border-0" style="border-radius: 8px;">
                                    ...
                                    <div class="options-container" style="max-height: 200px; overflow-y: auto;">
                                        <?php foreach ($nurses as $nurse): ?>
                                            <label class="dropdown-item d-flex align-items-center gap-2 rounded option-item">
                                                <input class="form-check-input mt-0 item-checkbox" type="checkbox" name="nurses[]" value="<?= $nurse['id'] ?>">
                    ...
                    <div class="d-flex gap-3 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary px-4 py-2 fw-bold" style="border-radius: 8px; box-shadow: 0 4px 10px rgba(13, 110, 253, 0.2);">
