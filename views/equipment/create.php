    ...
    <form method="POST" action="index.php?page=equipment&action=store">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="equipment_name" name="equipment_name" required placeholder="Máy thở, máy theo dõi...">
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="d-flex gap-3">
            <button type="submit" class="btn-submit"><i class="fa-solid fa-save me-2"></i>Lưu thiết bị</button>
