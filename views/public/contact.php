    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-5" data-aos="fade-right">
                ...
                <div class="service-card h-auto mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="service-icon flex-shrink-0" style="background:var(--primary-light);color:var(--primary);width:48px;height:48px;margin:0;display:flex;align-items:center;justify-content:center;">
                            <i class="fa-solid fa-location-dot"></i>
                        </div>
                        <div class="flex-grow-1" style="min-width: 0;">
                            <h6 style="font-weight:600;margin:0;">Địa chỉ</h6>
                            <p class="text-break" style="margin:0;color:var(--gray-500);font-size:14px;word-wrap:break-word;">123 Đường Nguyễn Văn Linh, Quận 7, TP. HCM</p>
                        </div>
                    </div>
                </div>
                <div class="service-card h-auto mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="service-icon flex-shrink-0" style="background:var(--secondary-light);color:var(--secondary);width:48px;height:48px;margin:0;display:flex;align-items:center;justify-content:center;">
                            <i class="fa-solid fa-phone"></i>
                        </div>
                        <div class="flex-grow-1" style="min-width: 0;">
                            <h6 style="font-weight:600;margin:0;">Điện thoại</h6>
                            <p class="text-break" style="margin:0;color:var(--gray-500);font-size:14px;word-wrap:break-word;">(028) 1234 5678</p>
                        </div>
                    </div>
                </div>
                <div class="service-card h-auto mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="service-icon flex-shrink-0" style="background:var(--accent-light);color:var(--accent);width:48px;height:48px;margin:0;display:flex;align-items:center;justify-content:center;">
                            <i class="fa-solid fa-envelope"></i>
                        </div>
                        <div class="flex-grow-1" style="min-width: 0;">
                            <h6 style="font-weight:600;margin:0;">Email</h6>
                            <p class="text-break" style="margin:0;color:var(--gray-500);font-size:14px;word-wrap:break-word;">info@novacare.vn</p>
                        </div>
                    </div>
                </div>
                <div class="service-card h-auto">
                    <div class="d-flex align-items-center gap-3">
                        <div class="service-icon flex-shrink-0" style="background:#fef3c7;color:var(--warning);width:48px;height:48px;margin:0;display:flex;align-items:center;justify-content:center;">
                            <i class="fa-solid fa-clock"></i>
                        </div>
                        <div class="flex-grow-1" style="min-width: 0;">
                            <h6 style="font-weight:600;margin:0;">Giờ làm việc</h6>
                            <p class="text-break" style="margin:0;color:var(--gray-500);font-size:14px;word-wrap:break-word;">T2 - T7: 7:00 - 17:00 | CN: 7:00 - 12:00</p>
                        </div>
                    </div>
                </div>
            </div>
