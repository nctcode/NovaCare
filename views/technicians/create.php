<!-- Form Thêm Kỹ thuật viên -->
<div class="form-section" data-aos="fade-up">
    <h5 class="mb-4"><i class="fa-solid fa-flask-vial me-2"></i>Thêm Kỹ thuật viên mới</h5>

    <form method="POST" action="index.php?page=technicians&action=store">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="specialty" name="specialty" placeholder="Ví dụ: Chẩn đoán hình ảnh, Xét nghiệm máu, Siêu âm...">
            </div>
        </div>
